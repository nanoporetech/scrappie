...
int get_raw_model_stride(const enum raw_model_type model){
    ...
    case SCRAPPIE_MODEL_HUMAN_R9_4_1:
        return conv_rgrgr_human_r941_stride;
    case SCRAPPIE_MODEL_INVALID:
        errx(EXIT_FAILURE, "Invalid scrappie model %s:%d", __FILE__, __LINE__);
    default:
        errx(EXIT_FAILURE, "Scrappie enum failure -- report bug\n");
...
posterior_function_ptr get_posterior_function(const enum raw_model_type model){
    ...
    case SCRAPPIE_MODEL_HUMAN_R9_4_1:
        return nanonet_human_r941_posterior;
    case SCRAPPIE_MODEL_INVALID:
        errx(EXIT_FAILURE, "Invalid scrappie model %s:%d", __FILE__, __LINE__);
    default:
        errx(EXIT_FAILURE, "Scrappie enum failure -- report bug\n");
...
scrappie_matrix nanonet_human_r941_posterior(const raw_table signal, float min_prob,
    ...
    scrappie_matrix raw_mat = nanonet_features_from_raw(signal);
    scrappie_matrix conv =
        convolution(raw_mat, conv_rgrgr_human_r941_W, conv_rgrgr_human_r941_b, conv_rgrgr_human_r941_stride, NULL);
    elu_activation_inplace(conv);
    raw_mat = free_scrappie_matrix(raw_mat);
    //  First GRU layer
    scrappie_matrix gruB1in = feedforward_linear(conv, gruB1_rgrgr_human_r941_iW, gruB1_rgrgr_human_r941_b, NULL);
    conv = free_scrappie_matrix(conv);
    scrappie_matrix gruB1 = gru_backward(gruB1in, gruB1_rgrgr_human_r941_sW, gruB1_rgrgr_human_r941_sW2, NULL);
    gruB1in = free_scrappie_matrix(gruB1in);
    //  Second GRU layer
    scrappie_matrix gruF2in = feedforward_linear(gruB1, gruF2_rgrgr_human_r941_iW, gruF2_rgrgr_human_r941_b, NULL);
    gruB1 = free_scrappie_matrix(gruB1);
    scrappie_matrix gruF2 = gru_forward(gruF2in, gruF2_rgrgr_human_r941_sW, gruF2_rgrgr_human_r941_sW2, NULL);
    gruF2in = free_scrappie_matrix(gruF2in);
    //  Third GRU layer
    scrappie_matrix gruB3in = feedforward_linear(gruF2, gruB3_rgrgr_human_r941_iW, gruB3_rgrgr_human_r941_b, NULL);
    gruF2 = free_scrappie_matrix(gruF2);
    scrappie_matrix gruB3 = gru_backward(gruB3in, gruB3_rgrgr_human_r941_sW, gruB3_rgrgr_human_r941_sW2, NULL);
    gruB3in = free_scrappie_matrix(gruB3in);
    //  Fourth GRU layer
    scrappie_matrix gruF4in = feedforward_linear(gruB3, gruF4_rgrgr_human_r941_iW, gruF4_rgrgr_human_r941_b, NULL);
    gruB3 = free_scrappie_matrix(gruB3);
    scrappie_matrix gruF4 = gru_forward(gruF4in, gruF4_rgrgr_human_r941_sW, gruF4_rgrgr_human_r941_sW2, NULL);
    gruF4in = free_scrappie_matrix(gruF4in);
    //  Fifth GRU layer
    scrappie_matrix gruB5in = feedforward_linear(gruF4, gruB5_rgrgr_human_r941_iW, gruB5_rgrgr_human_r941_b, NULL);
    gruF4 = free_scrappie_matrix(gruF4);
    scrappie_matrix gruB5 = gru_backward(gruB5in, gruB5_rgrgr_human_r941_sW, gruB5_rgrgr_human_r941_sW2, NULL);
    gruB5in = free_scrappie_matrix(gruB5in);

    scrappie_matrix post = softmax_with_temperature(gruB5, FF_rgrgr_human_r941_W, FF_rgrgr_human_r941_b, tempW, tempb, NULL);
    gruB5 = free_scrappie_matrix(gruB5);
